...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_page_type" AS ENUM('standard', 'about');
  ...
  CREATE TYPE "public"."enum__pages_v_version_page_type" AS ENUM('standard', 'about');
  ...
  CREATE TYPE "public"."enum_site_settings_primary_cta_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "pages_about_content_credentials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar
  ...
  CREATE TABLE "pages_about_content_sidebar_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages" (
  	...
  	"about_content_headline" varchar,
  	"about_content_bio" varchar,
  	"about_content_portrait_id" integer,
  	"meta_title" varchar,
  ...
  CREATE TABLE "_pages_v_version_about_content_credentials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_pages_v_version_about_content_sidebar_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_about_content_headline" varchar,
  	"version_about_content_bio" varchar,
  	"version_about_content_portrait_id" integer,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"primary_cta_type" "enum_site_settings_primary_cta_type" DEFAULT 'reference',
  ...
  ALTER TABLE "pages_about_content_credentials" ADD CONSTRAINT "pages_about_content_credentials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_about_content_sidebar_items" ADD CONSTRAINT "pages_about_content_sidebar_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages" ADD CONSTRAINT "pages_hero_media_id_media_id_fk" FOREIGN KEY ("hero_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages" ADD CONSTRAINT "pages_about_content_portrait_id_media_id_fk" FOREIGN KEY ("about_content_portrait_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_version_about_content_credentials" ADD CONSTRAINT "_pages_v_version_about_content_credentials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_version_about_content_sidebar_items" ADD CONSTRAINT "_pages_v_version_about_content_sidebar_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_parent_id_pages_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_hero_media_id_media_id_fk" FOREIGN KEY ("version_hero_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_about_content_portrait_id_media_id_fk" FOREIGN KEY ("version_about_content_portrait_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_about_content_credentials_order_idx" ON "pages_about_content_credentials" USING btree ("_order");
  CREATE INDEX "pages_about_content_credentials_parent_id_idx" ON "pages_about_content_credentials" USING btree ("_parent_id");
  CREATE INDEX "pages_about_content_sidebar_items_order_idx" ON "pages_about_content_sidebar_items" USING btree ("_order");
  CREATE INDEX "pages_about_content_sidebar_items_parent_id_idx" ON "pages_about_content_sidebar_items" USING btree ("_parent_id");
  CREATE INDEX "pages_hero_hero_media_idx" ON "pages" USING btree ("hero_media_id");
  CREATE INDEX "pages_about_content_about_content_portrait_idx" ON "pages" USING btree ("about_content_portrait_id");
  ...
  CREATE INDEX "_pages_v_version_about_content_credentials_order_idx" ON "_pages_v_version_about_content_credentials" USING btree ("_order");
  CREATE INDEX "_pages_v_version_about_content_credentials_parent_id_idx" ON "_pages_v_version_about_content_credentials" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_version_about_content_sidebar_items_order_idx" ON "_pages_v_version_about_content_sidebar_items" USING btree ("_order");
  CREATE INDEX "_pages_v_version_about_content_sidebar_items_parent_id_idx" ON "_pages_v_version_about_content_sidebar_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_parent_idx" ON "_pages_v" USING btree ("parent_id");
  CREATE INDEX "_pages_v_version_hero_version_hero_media_idx" ON "_pages_v" USING btree ("version_hero_media_id");
  CREATE INDEX "_pages_v_version_about_content_version_about_content_por_idx" ON "_pages_v" USING btree ("version_about_content_portrait_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_about_content_credentials" CASCADE;
  DROP TABLE "pages_about_content_sidebar_items" CASCADE;
  ...
  DROP TABLE "_pages_v_version_about_content_credentials" CASCADE;
  DROP TABLE "_pages_v_version_about_content_sidebar_items" CASCADE;
  ...
  DROP TYPE "public"."enum_site_settings_primary_cta_type";
